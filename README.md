...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hm0ltkc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hm0ltkc.containers.anotherwebservice.com/
...
```
git clone git@github.com:tkdream11/container-hm0ltkc.git
cd container-hm0ltkc
```
...
```
docker attach container-hm0ltkc
```
